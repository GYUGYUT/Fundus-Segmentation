...
os.environ["CUDA_VISIBLE_DEVICES"]= "2,3"  # Set the GPU 0 to use
...
def run():
    ...
    wandb.run.name = str("soft_Hyper_31_mobilev2_") + str(args.arch) + "_" + str(cfg["lr"]) + "_" + str(cfg["batch_size"]) + "_" + str(cfg["imgsize"]) + "_" + str(cfg["num_class"]) 
    wandb.run.save()
